                        ...
                        <div className="footer-item">
                            <div className="footer-company">
                                ...
                                <ul className="text-gray-600">
                                    <li className="mb-2">
                                        <a href="/about" target="_blank" className="hover:underline">About</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="/services" target="_blank" className="hover:underline">Services</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="/projects" target="_blank" className="hover:underline">Projects</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="/team" target="_blank" className="hover:underline">Team</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="/blog" target="_blank" className="hover:underline">Blog</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                        <div className="footer-item">
                            <div className="footer-company">
                                ...
                                <ul className="text-gray-600">
                                    <li className="mb-2">
                                        <a href="/faq" target="_blank" className="hover:underline">FAQ</a>
                                    </li>
                                    <li className="mb-2">
                        ...
                        <div className="footer-item">
                            <div className="footer-contact">
                                ...
                                <ul className="text-gray-600">
                                    ...
                                    <li className="mb-2">
                                        <span>Phone: </span>
                                        <a href="tel:+0123456789" target="_blank" className="hover:underline">+012 3456 789</a>
                                    </li>
                                </ul>
                            </div>
