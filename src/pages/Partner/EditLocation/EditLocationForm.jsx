  ...
  return (
    ...
    >
      {({ errors, touched, setFieldValue, isValid, isSubmitting }) => {
        ...
        return (
          <Form
            className="overflow-y-auto p-6 bg-white shadow-xl rounded-lg"
                  ...
                  {[
                    ...
                    <label key={day} className="inline-flex items-center">
                      <Field
                        ...
                        name="closedDays"
                        value={day}
                        className="form-checkbox h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-indigo-500"
                      />
