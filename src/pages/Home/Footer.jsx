        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 lg:w-1/5 px-6 mb-8">
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.about}</a></li>
              <li><a href="/#services" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.services}</a></li>
              <li><a href="/#projects" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.projects}</a></li>
              <li><a href="/#team" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.team}</a></li>
              <li><a href="/#blog" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.blog}</a></li>
            </ul>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/5 px-4 mb-8">
            ...
            <ul className="space-y-2">
              <li><a href="/#faq" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.faq}</a></li>
              <li><a href="/privacy-policy" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.privacyPolicy}</a></li>
              <li><a href="/terms-and-conditions" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.terms}</a></li>
              <li><a href="#" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.community}</a></li>
              <li><a href="/contact" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.contact}</a></li>
              <li><a href="/support" className="hover:underline hover:text-teal-200 transition-colors duration-300">{t.support}</a></li>
            </ul>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/5 px-4 mb-8">
          ...
          <div className="w-full md:w-1/2 lg:w-1/5 px-4 mb-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/profile.php?id=61564185476772" target='_blank' className="text-white hover:text-blue-600 transition-colors duration-300 text-3xl p-2">
