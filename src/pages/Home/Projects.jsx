...
import plumbing from '/files/img/home-two/plumbing-1.jpg';
import house from '/files/img/home-two/house-1.jpg';
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
            <div className="card bg-white p-6 rounded-lg shadow-md">
              <img src={furniture} alt="Service" className="mb-4 rounded-lg" width={300} height={300}/>
              ...
              <a href="/service" className="hover:underline">Learn More</a>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
            <div className="card bg-white p-6 rounded-lg shadow-md">
              <img src={plumbing} alt="Service" className="mb-4 rounded-lg" width={300} height={300}/>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
            <div className="card bg-white p-6 rounded-lg shadow-md">
              <img src={house} alt="Service" className="mb-4 rounded-lg" width={300} height={300}/>
