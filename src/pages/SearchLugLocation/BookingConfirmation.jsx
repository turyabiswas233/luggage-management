...
import logo from "../../assets/img/home-two/logo3.svg"; // Assume logo is in the assets folder
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              ...
              <p className="mb-2">
                <strong>Check-in Time:</strong> {bookingDetails.startTime}
              </p>
              <p className="mb-2">
                <strong>Check-out Time:</strong> {bookingDetails.endTime}
              </p>
              <p className="mb-2">
                <strong>Name:</strong> {bookingDetails.guest.name}
              </p>
              <p className="mb-2">
                <strong>Email:</strong> {bookingDetails.guest.email}
              </p>
              <p className="mb-2">
                <strong>Phone:</strong> {bookingDetails.guest.phone}
              </p>
              <p className="mb-2">
              ...
              <p className="mb-2">
                <strong>Discount:</strong> ${bookingDetails.discount.toFixed(2)}
              </p>
              <p className="mb-2">
              ...
              <p className="mb-2">
                ...
                {bookingDetails.payment.amount.toFixed(2)}
              </p>
            </div>
